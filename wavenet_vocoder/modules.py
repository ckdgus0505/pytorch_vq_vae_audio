...
#removed causal parameter, because we only need causal=True convolutions.
class ResidualConv1dGLU(nn.Module):
    ...
    def _forward(self, x, c, g, is_incremental):
        ...
        x = (x + residual) #I REMOVED MULTIPLICATION BY MATH.SQRT(0.5) BECAUSE IT WAS NOT MENTIONED IN THE WAVENET PAPER
